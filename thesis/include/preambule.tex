...
%% Перенос длинных строк (текст и листинги verbatim)
...
%% Моноширинный текст с возможностью переноса
\usepackage{seqsplit}
\newcommand{\tx}[1]{\texttt{\seqsplit{#1}}}
...
\definecolor{codeorange}{rgb}{0.80,0.40,0.15}

\lstdefinestyle{schemastyle}{
    backgroundcolor=\color{white},
    basicstyle=\ttfamily\small,
    keywordstyle=\color{codegreen},
    morekeywords={Object,Array,String,Integer,Boolean,Number,Null,Enum},
    stringstyle=\itshape\color{codeorange},
    morestring=[b]",
    numbers=none,
    frame=none,
    showspaces=false,
