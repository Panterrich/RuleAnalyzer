...
\author[Дурнов А. Н.]{%
    \texorpdfstring{%
        \begin{tabular}{c}
            \underline{Дурнов Алексей Николаевич}\\[-0.15em]
            {\footnotesize\itshape докладчик}\\[0.75em]
            Каплин Артём Андреевич\\[0.35em]
            Ларин Дмитрий Викторович\\[0.35em]
            Ефанов Николай Николаевич
        \end{tabular}
    }{Дурнов А. Н.; Каплин Артём Андреевич; Ларин Д. В.; Ефанов Н. Н.}%
}

\setbeamerfont{institute}{size*={11}{13.2},series=\mdseries}
...
\begin{frame}{Время выполнения}
    \centering
    \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{benchmark_plots_time.png}
\end{frame}

\begin{frame}{Время выполнения (логарифмическая шкала)}
    \centering
    \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{benchmark_plots_log.png}
\end{frame}

\begin{frame}{Пиковое потребление памяти}
    \centering
    \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{benchmark_plots_peak.png}
\end{frame}
